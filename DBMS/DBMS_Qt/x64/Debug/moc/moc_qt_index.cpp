...
QT_MOC_LITERAL(1, 9, 18), // "qt_update_ComboBox"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "qt_index\0qt_update_ComboBox\0"
};
...
void qt_index::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<qt_index *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->qt_update_ComboBox(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject qt_index::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_qt_index.data,
    qt_meta_data_qt_index,
    qt_static_metacall,
    nullptr,
    nullptr
} };
