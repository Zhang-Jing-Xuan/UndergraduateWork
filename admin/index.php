<?php
    ...
    $count_content_module=num($link,$query);
    $query="select count(*) from reply";
	$count_reply_module=num($link,$query);
...
<div id="main">
	...
	<div class="explain">
		<ul>
			<li>|- 父版块(<?php echo $count_father_module?>) 子板块(<?php echo $count_son_module?>) 帖子(<?php echo $count_content_module?>) 回复(<?php echo $count_reply_module?>) 会员(<?php echo $count_member?>) 管理员(<?php echo $count_manage?>)</li>
		</ul>
	</div>
	<div class="explain">
		<ul>
	...
	<div class="explain">
		<ul>
			...
			<li>|- 程序作者：张景轩 :))</li>
			<li>|- 网站：<a target="_blank" href="http://www.baidu.com">www.baidu.com</a></li>
		</ul>
	</div>
</div>
